...
SECRET_KEY = 'django-insecure-f6tqy$(dr9w=96$ldrv38lxkce)tj)qc@y*44jjf0@===^&s7o'
...
# ✅ Tell Django where your custom static folders are
STATICFILES_DIRS = [
...
# ✅ Optional: fix for missing context processor
